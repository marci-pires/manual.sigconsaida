...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------------------------: | :---------------------: | ----------------------- |
| Objetivos voltados à promoção de atividades e finalidades de relevância pública e social                                                                                                                                                                                                           |          :white\_check\_mark:         |           :x:           | :x:                     |
| <p>Cláusula prevendo que:</p><p>Em caso de dissolução da entidade, o respectivo patrimônio líquido seja transferido a pessoa jurídica de igual natureza que preencha os requisitos da Lei Federal nº13.019, de 2014 e cujo objeto social seja, preferencialmente, o mesmo da entidade extinta.</p> |          :white\_check\_mark:         |           :x:           | :x:                     |
| <p>Cláusula prevendo que:</p><p>A escrituração se encontra de acordo com os princípios fundamentais de contabilidade e com as Normas Brasileiras de Contabilidade</p>                                                                                                                              |          :white\_check\_mark:         |   :white\_check\_mark:  | :white\_check\_mark:    |
...
{% hint style="success" %}
As OSCs podem solicitar apoio dos núcleos de prática jurídica das faculdades de direito para orientar a alteração de suas normas de organização interna.
{% endhint %}

No caso de associações e fundações, as regras estão dispostas nos arts. 59 e 67, respectivamente da [Lei 10.406, de 2002](http://www.planalto.gov.br/ccivil\_03/leis/2002/L10406compilada.htm) (Código Civil), no caso das cooperativas o art. 1.093 do Código Civil, as sociedades cooperativas são regidas pelo disposto em referente capítulo. No que a lei for omissa, aplicam-se as disposições referentes à sociedade simples (art.999, CC).

Portanto, vale avaliar qual dispositivo se aplica ao caso concreto e o que deverá ser observado ao realizar as alterações necessárias.
...
{% hint style="success" %}
OSCs de assistência social: no momento da solicitação do registro da alteração estatutária no cartório de registro civil, informe ao tabelião a isenção de taxas.
{% endhint %}

Outros requisitos para celebração do instrumento são elencados no artigo 33 da Lei Federal 13.019, de 2014, abaixo segue o quadro contendo os requisitos e seu momento de verificação:
...
| Esteja omissa no dever de prestar contas de parceria anterior- mente celebrada                                                                                                                                                                       |                        Checklist de Celebração (Siafi-MG normal e ausência de registro Cadin)                        |
